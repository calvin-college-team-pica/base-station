#!/usr/bin/perl -w
# DriveGnuPlots.pl based on script found on the internet...site unknown
# Used by Team PICA for Senior Design project to pipe data into GNUplot
#    to display data from our base-station serial-port reader script.
###############################################################################
use strict;
